...
class StreamViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let tweetButton  = UIBarButtonItem(barButtonSystemItem: .Compose, target: self, action: #selector(StreamViewController.postTweet))
    ...
    func postTweet()
    {
        ...
        view.setInitialText("Hello CIS 380!")
